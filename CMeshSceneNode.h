...
namespace scene
{
	...
	public:
		...
		virtual IShadowVolumeSceneNode* addShadowVolumeSceneNode(const IMesh* shadowMesh,
			s32 id, bool zfailmethod=true, f32 infinity=10000.0f) {return NULL;}
		...
		void SetBox (core::aabbox3df box);
		void setWireFrame(bool bWire) {this->bWireframe=bWire; }
	...
	protected:
		...
		static video::SColor m_unique_color;
        static video::ITexture* m_color_tex;
	};
