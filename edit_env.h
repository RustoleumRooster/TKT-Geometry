...
enum
{
    ...
    GUI_ID_VIEWPORT_2D_RIGHTCLICK_MENU_ITEM_CAMERA_RESET,
    ...
    GUI_ID_VIEWPORT_2D_RIGHTCLICK_MENU_ITEM_SAVE_NODE_SELECTION,
    ...
    GUI_ID_VIEWPORT_3D_RIGHTCLICK_MENU_ITEM_CAMERA_RESET,
